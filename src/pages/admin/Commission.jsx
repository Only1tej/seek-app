                            ...
                            <div>
                                <div>
                                    ...
                                    <div className='flex flex-row justify-between ml-[20px] mt-[71px]'>
                                        <div className="tabs">
                                            <a href='/admin/pending-orders' className="tab tab-bordered tab-active leading-loose">Commission</a>
                                        </div>
                                        {/* Search input */}
                                        ...
                                        <table className='table w-[1440px] h-[48px] ml-[21px] divide-y divide-gray-300'>
                                            ...
                                            <thead>
                                                ...
                                                <tr className='rounded'>
                                                    ...
                                                    <th className='text-base font-semibold normal-case'>Pay</th>
                                                </tr>
                                            ...
                                            <tbody className=''>
                                                ...
                                                <tr className=''>
                                                    ...
                                                    <td>
                                                        <div className='whitespace-nowrap text-lg py-2'>€45.50</div>
                                                    </td>
                                                    <td>
                                                        <div className='whitespace-nowrap text-lg py-2'>Pay Commission</div>
                                                    </td>
                                                </tr>
