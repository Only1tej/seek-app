                        ...
                        <div className='flex flex-col'>
                            <Link to='/admin/pending-orders'>
                                <div className='flex items-start'>
                                    <button className='btn normal-case  rounded-none outline-none border-none bg-slate-950 hover:bg-gradient-to-r from-[#FFD68A] to-[#AE926C]  pt-[11px] pb-[10px] w-full '> <img src={documentDownload} alt="grid" className='w-[24px] h-[24px] mr-[24px]' />Pending Orders</button>
                                </div>
                            </Link>
                            <Link to='/admin/completed-orders'>
                                <div className='flex items-center'>
                                    <button className='btn normal-case rounded-none outline-none border-none bg-slate-950 hover:bg-gradient-to-r from-[#FFD68A] to-[#AE926C] pt-[11px] pb-[10px] w-full '><img src={taskSquare} alt="grid" className='w-[24px] h-[24px] mr-[24px]' />
                                        Completed Orders</button>
                                </div>
                            </Link>
                            <Link to='/admin/commission'>
                                <div className='flex items-start'>
                                    <button className='btn normal-case  rounded-none outline-none border-none bg-slate-950 hover:bg-gradient-to-r from-[#FFD68A] to-[#AE926C] pt-[11px] pb-[10px] w-full '><img src={receiptDiscount} alt="grid" className='w-[24px] h-[24px] mr-[24px]' />
                                        Commission</button>
                                </div>
                            </Link>
                            <Link to=''>
                                <div className="dropdown dropdown-bottom">
                                    <label tabIndex={0} className="btn normal-case rounded-none outline-none border-none bg-slate-950 hover:bg-gradient-to-r from-[#FFD68A] to-[#AE926C] pt-[11px] pb-[10px] w-[240px] "> <img src={securityUser} alt="grid" className='w-[24px] h-[24px] mr-[24px]' />Account</label>
                                    <ul className="dropdown-content menu rounded-none border-none w-[240px]">
                                        <Link to='/admin/change-password'>
                                            <button className='flex items-center text-center text-white bg-slate-950 hover:bg-gradient-to-r from-[#362609] to-[#201506] normal-case pt-[11px] pb-[10px] w-[240px] pl-[61px] font-normal text-xs'>Change Password</button>
                                        </Link>
                                        <Link to='/admin/user-list'>
                                            <button className='flex items-center text-white bg-slate-950 hover:bg-gradient-to-r from-[#362609] to-[#201506] normal-case pt-[11px] pb-[10px] w-[240px] pl-[61px] font-normal text-xs'>Invite Users</button>
                                        </Link>
                                    </ul>
                                </div>
                            </Link>
                                ...
                                <div>
                                    <div className='flex flex-row justify-between'>
                                        <div className='ml-[20px] mt-[23px]'>
                                            <h2 className="font-bold font-poppins text-3xl">Hello Roltz!</h2>
                                    ...
                                    <div className='flex flex-row justify-between ml-[20px] mt-[71px]'>
                                        <div className="tabs">
                                            <a href='/admin/pending-orders' className="tab tab-bordered tab-active leading-loose">Pending Orders</a>
                                        </div>
                                        {/* Search input */}
