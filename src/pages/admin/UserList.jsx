                ...
                <div className="w-full flex">
                    <div className='flex-1 flex flex-col'>
                        ...
                        <div className='flex-1 bg-[#E5E5E5] px-10 '>
                            <div className="container bg-[#FFFFFF] flex flex-col rounded-3xl ml96 mx-auto my-[97px] w-full md:w-[412px] h-[631px]">
                                <div>
                                    <h1 className='font-semibold text-2xl mt-8 text-center'>User List</h1>
                                    <hr className='scale-50 mb-[36px] bg-gradient-to-r from-[rgb(255,214,138)] to-[#AE926C] ' />
                                </div>
                                <div>
                                    <div className='flex flex-row mx-[46px]'>
                                        <div className="avatar placeholder">
                                            <div className="bg-slate-200 text-[#B4B4B4] rounded-full w-12 h-12 mt-6 mr-[12px]">
                                        ...
                                        <div>
                                            <div className='flex flex-row justify-between mt-[16px]'>
                                                <div>
                                                    <h1 className='text-xl font-medium'>Roltz</h1>
                                                    <h1 className='text-sm font-normal mt-[2px] '>email:roltz@abc.com</h1>
                                                </div>
                                                <div>
                                                    <button id='remove' onClick={closeRemove} className="btn btn-circle btn-outline ml-[72px]" >
                                    ...
                                    <div className='flex flex-row mt-[24px] mx-[46px]'>
                                        <div className="avatar placeholder">
                                            <div className="bg-slate-200 text-[#B4B4B4] rounded-full w-12 h-12 mt-6 mr-[12px]">
                                                <span className="text-sm">RK</span>
                                            </div>
                                        ...
                                        <div>
                                            <div className='flex flex-row justify-between mt-[16px]'>
                                                ...
                                                <div>
                                                    <button onClick={closeRemove} className="btn btn-circle btn-outline ml-[72px]" id='remove-user'>
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" /></svg>
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <Link to=''>
                                        <button onClick={() => setShowModal(true)} className="btn bg-slate-950 hover:bg-slate-950 rounded-full w-[316px] normal-case mx-[48px] mb-[px] mt-[86px] items-center">Invite User</button></Link>
                                </div>
                            </div>
                        </div>
                        <InviteUsers onClose={handleOnClose} visible={showModal} />
                        <RemoveUser visible={showRemoveModal} onRemoveClose={handleRemoveClose} />
                    </div>
                </div>
            </div>
        </div>
