                        ...
                        <div className='flex-1 bg-[#E5E5E5] px-10 '>
                            <div className="container bg-[#FFFFFF] flex justify-center rounded-3xl ml96 mx-auto my-24 w-full md:w-[412px] h-[631px]">
                                <form className='form-control'>
                                    <h1 className='font-semibold text-2xl mt-8 text-center'>Start New Order</h1>
                                    {/* <div className="divider w-full flex justify-center scale-50  bg-yellow-700"></div> */}
                                    <hr className='scale-50 mb-12 bg-gradient-to-r from-[#FFD68A] to-[#AE926C] ' />
                                    <input type="text" name='itemname' placeholder='Item Name' className='form-input py-3  rounded-full text-center items-center border-2 w-[316px] mx-[48px]' />
                                    <input type="text" name='price' placeholder='Price' className='form-input py-3 rounded-full text-center mt-4 border-2 w-[316px] mx-[48px] ' />
                                    <input type="text" name='discountCode' placeholder='Discount Code' className='form-input py-3 rounded-full text-center mt-4 border-2 w-[316px] mx-[48px] ' />
                                    <input type="text" name='cardNumber' placeholder='Card Number' className='form-input py-3 rounded-full text-center mt-4 border-2 w-[316px] mx-[48px]' />
                                    ...
                                    <div className="flex mt-4 mb-6 ml-[51px] mr-[50px]">
                                        <input type="checkbox" unchecked className="checkbox" /><p className='text-sm font-normal'>I agree to Roltz BNPL Terms & Conditions</p></div>
                                    <button className="btn bg-slate-950 rounded-full w-[316px] normal-case mx-[48px] mb-[30px] mt-[75px] items-center">Start Order</button>
                                </form>
                            </div>
                        </div>
                        {/* <div>hello there</div> */}
