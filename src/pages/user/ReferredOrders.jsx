                            ...
                            <div>
                                <div>
                                    ...
                                    <div className='ml-[20px] mt-[71px]'>
                                        <div className="tabs">
                                            <a href='/my-orders' className="tab tab-bordered">My Orders</a>
                                            <a href='/referred-orders' className="tab tab-bordered tab-active">Referred Orders</a>
                                        </div>
                                    </div>
                                        ...
                                        <table className='table w-[1440px] h-[48px] ml-[21px] divide-y divide-gray-300'>
                                            ...
                                            <thead>
                                                <tr className='rounded'>
                                                    ...
                                                    <th className='text-base font-semibold normal-case'>Payment</th>
                                                    <th className='text-base font-semibold normal-case'>Commission</th>
                                            ...
                                            <tbody className=''>
                                                ...
                                                <tr className=''>
                                                    ...
                                                    <td>
                                                        <div className='whitespace-nowrap text-lg py-2'>In Progress</div>
                                                    </td>
                                                    <td>
                                                        <div className='whitespace-nowrap text-lg py-2'>€65.00 (Locked)</div>
                                                    </td>
                                                    <td>
